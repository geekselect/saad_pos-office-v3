...
class ThemeHelper{
  ...
  BoxDecoration buttonBoxDecoration(BuildContext context, [String color1 = "", String color2 = ""]) {
    Color c1 = Color(Constants.colorTheme).withOpacity(0.9);
    Color c2 = Color(Constants.colorTheme).withOpacity(0.4);
    ...
    return BoxDecoration(
      boxShadow: [
        BoxShadow(color: c1, offset: const Offset(0, 4), blurRadius: 5.0)
      ],
