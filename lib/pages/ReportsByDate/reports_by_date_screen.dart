                                      ...
                                      child: IntrinsicWidth(
                                        child: Row(
                                          children: [
                                            ...
                                            Text(" From : ${DateFormat('yyyy-MM-dd').format(_reportByDateController.reportByDateModelData.value.data!.first.date!)} to ${DateFormat('yyyy-MM-dd').format(_reportByDateController.reportByDateModelData.value.data!.last.date!)}", style: const TextStyle(
                                                color: Colors.white,
                                                fontSize: 16,
                                                fontWeight: FontWeight.bold),),
                                          ],
                                                  ...
                                                  child: IntrinsicWidth(
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Text(" Total Item Sold (From : ${DateFormat('yyyy-MM-dd').format(_reportByDateController.reportByDateModelData.value.data!.first.date!)}  to ${DateFormat('yyyy-MM-dd').format(_reportByDateController.reportByDateModelData.value.data!.last.date!)})", style: const TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 16,
                                                            fontWeight: FontWeight.bold),),
                                                      ],
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    CustomNewRow("Total Sum Pos", _reportByDateController.reportByDateModelData.value.sumPosTotal!.toString()),
