...
class PaypalServices {
  ...
  String clientId = AuthController.sharedPreferences!.getString(Constants.appPaypalClientId) ?? ''; // from api
  String secret = AuthController.sharedPreferences!.getString(Constants.appPaypalSecretKey) ?? ''; // from api
