 ...
 @override
  void initState() {
   ...
   if(_cartController.cartMaster!=null){
     callOrderSettingRef = _cartController.callOrderSetting(_cartController.cartMaster!.vendorId);
    ...
    statusRef=_orderCustimizationController.status(_cartController.cartMaster!.vendorId);
   }
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
   print("name ${ _cartController.userName}");
    ...
    if(_cartController.cartMaster==null || _cartController.cartMaster!.cart.isEmpty){
      return Scaffold(
        ...
        body:Container(
            ...
            child: Center(child: Text("No data in the cart"),)),
      );
    }else{
     return FutureBuilder<BaseModel<OrderSettingModel>>(
         future: _cartController.callOrderSetting(_cartController.cartMaster!.vendorId),
             ...
             return GetBuilder<CartController>(
               ...
               builder: (controller){
                 if(_cartController.diningValue){
                   ...
                   if(_cartController.cartMaster!=null){
                     for(int i=0;i<_cartController.cartMaster!.cart.length;i++)
                       totalAmount+=_cartController.cartMaster!.cart[i].totalAmount;
                   ...
                   if(orderSettingModel.data?.data!.taxType==1){
                     _cartController.calculatedTax=_cartController.calculatedAmount*double.parse(orderSettingModel.data!.data!.tax!)/100;
                     ...
                     color: Color(Constants.colorScreenBackGround),
                       ...
                       child: SafeArea(
                         child: SingleChildScrollView(
                           child: Column(
                             children: [
                               if(picked!=null && selectedDate!=null && scheduleMethod!=ScheduleMethod.DELIVERNOW)
                                 Row(
                                         ...
                                         onTap: ()async{
                                           ...
                                           if(selectedDate!=null){
                                             ...
                                             if(picked!=null){
                                               ...
                                               Get.snackbar('ALERT', 'Please Select Time');
                                             }
                                           }else{
                                             Get.snackbar('ALERT', 'Please Select Date');
                                           }
                                         },
                                         child: Text("  Edit here", style: TextStyle(decoration: TextDecoration.underline, color: Colors.blue))),
                                   ],),
                               SizedBox(
                               ...
                               // getCouponWidget(),
                               SizedBox(
                                 height:!_cartController.isPromocodeApplied? ScreenConfig.blockHeight*19:ScreenConfig.blockHeight*20,
                                 child: getTotalAmountWidget(orderSettingModel),
                               ),
                               Padding(
                                 padding: const EdgeInsets.only(left: 6.0,right: 6.0,bottom: 2.0,top: 0.0),
                                 child: Row(
                                   mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                   children: [
                                     Expanded(
                                       child: RoundedCornerAppButton(btnLabel: "Checkout", onPressed: (){
                                         ...
                                         Navigator.push(
                                           context,
                                           MaterialPageRoute(builder: (context) => PosPayment(
                                             mobileNumber: phoneNoController.text,
                                             userName: nameController.text,
                                             venderId: _cartController.cartMaster!.vendorId,
                                             orderDeliveryType:(){
                                               if(_cartController.diningValue){
                                                 return 'DINING';
                                               }else{
                                             ...
                                             orderDate:  DateFormat('y-MM-dd').format(DateTime.now()).toString(),
                                             orderTime:DateFormat('hh:mm a').format(DateTime.now()).toString(),
                                             totalAmount: _cartController.calculatedAmount,
                                             addressId: 0,
                                             orderDeliveryCharge:"${_cartController.deliveryCharge}",
                                             orderStatus: "PENDING",
                                             ordrePromoCode: _cartController.appliedCouponName,
                                             vendorDiscountAmount:_cartController.discountAmount,
                                             vendorDiscountId:int.parse(_cartController.strAppiedPromocodeId),
                                             strTaxAmount:_cartController.calculatedTax.toString(),
                                             allTax:[],
                                             subTotal: subTotal,
            ...
            child: ListView.builder(
              ...
              shrinkWrap: true,
                ...
                itemBuilder: (context,index){
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(child: Text('${cart.menu[0].totalAmount}',style: TextStyle(
                  ...
                  else if(_cartController.cartMaster!.cart[index].category=="HALF_N_HALF"){
                    return Container(
                      margin: EdgeInsets.symmetric(horizontal: 8.0),
                      decoration: BoxDecoration(
                        color: Constants.secondaryColor,
                          ...
                          children: [
                            Flexible(
                              ...
                              child: Column(
                                ...
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Flexible(child: Text('${cart.totalAmount}'),),
                                  Flexible(
                                    fit: FlexFit.loose,
                                    child:Padding(
                  ...
                  else if(_cartController.cartMaster!.cart[index].category=="DEALS"){
                    return Container(
                      margin: EdgeInsets.symmetric(horizontal: 8.0),
                      decoration: BoxDecoration(
                        color: Constants.secondaryColor,
 ...
 if (_cartController.cartMaster!=null || _cartController.cartMaster!.cart.length>0) {
   if (!_cartController.isPromocodeApplied) {
     return GestureDetector(
       child: Padding(
         padding: const EdgeInsets.only(left: 10.0,right: 10.0,top: 10.0,bottom: 2.0),
         child: DottedBorder(
              ...
              (){
                if(selectMethod.index==1){
                  if( orderSettingModel.data!.data!.freeDelivery==1){
                    ...
                    if(orderSettingModel.data!.data!.freeDeliveryDistance!=0 &&
                        orderSettingModel.data!.data!.freeDeliveryAmount!=0){
                      if(
                      _cartController.calculatedAmount>=orderSettingModel.data!.data!.freeDeliveryAmount! &&
                          orderSettingModel.data!.data!.distance!<=orderSettingModel.data!.data!.freeDeliveryDistance!
                      ){
                        return Text('Delivery Free');
                      }else{
                        print(_cartController.calculatedAmount);
                        _cartController.deliveryCharge=_cartController.calculatedAmount*0.1;
                        _cartController.calculatedAmount+=_cartController.deliveryCharge;
                        // print()
                        return Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  right: ScreenUtil()
                                      .setWidth(10)),
                              child: Text(_cartController.deliveryCharge.toStringAsFixed(2),
                                style: TextStyle(
                                    fontFamily:
                                    Constants.appFont,
                                    fontSize: ScreenUtil()
                    ...
                    }else if(orderSettingModel.data!.data!.freeDeliveryDistance==0){
                      if(_cartController.calculatedAmount>=orderSettingModel.data!.data!.freeDeliveryAmount!){
                        return Text('Delivery Free');
                      }else{
                        _cartController.deliveryCharge=_cartController.calculatedAmount*0.1;
                        _cartController.calculatedAmount+=_cartController.deliveryCharge;
                    ...
                    }else if(orderSettingModel.data!.data!.freeDeliveryAmount==0){
                      if(orderSettingModel.data!.data!.distance!<=orderSettingModel.data!.data!.freeDeliveryDistance!){
                        return Text('Delivery Free');
                      }else{
                        print(_cartController.calculatedAmount);
                        _cartController.deliveryCharge=_cartController.calculatedAmount*0.1;
    ...
    final DateTime? picked = await showDatePicker(
      ...
      return Theme(
        data: ThemeData.light().copyWith(
          ...
          ), colorScheme: ColorScheme.light(primary:  Color(Constants.colorTheme)).copyWith(secondary: const Color(0xFF8CE7F1)),
        ),
        child: child!,
      );
    },);
  ...
  addButton(int index){
    double diningAmount=_cartController.cartMaster!.cart[index].diningAmount!/_cartController.cartMaster!.cart[index].quantity;
    _cartController.cartMaster!.cart[index].diningAmount=_cartController.cartMaster!.cart[index].diningAmount!+diningAmount;
    double amount=_cartController.cartMaster!.cart[index].totalAmount/_cartController.cartMaster!.cart[index].quantity;
