...
DealsSizes dealsSizesFromMap(String str) => DealsSizes.fromMap(json.decode(str));

String dealsSizesToMap(DealsSizes data) => json.encode(data.toMap());
...
class DealsSizes {
  ...
  factory DealsSizes.fromMap(Map<String, dynamic> json) => DealsSizes(
...
class Menu {
  ...
  factory Menu.fromMap(Map<String, dynamic> json) => Menu(
    ...
    createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
    updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
    singleMenu:List<SingleMenu>.from(json["single_menu"].map((x) => SingleMenu.fromMap(x))),
  );
  ...
  Map<String, dynamic> toMap() => {
    ...
    "created_at": createdAt == null ? null : createdAt!.toIso8601String(),
    "updated_at": updatedAt == null ? null : updatedAt!.toIso8601String(),
    "single_menu": List<dynamic>.from(singleMenu.map((x) => x.toMap())),
  };
}
